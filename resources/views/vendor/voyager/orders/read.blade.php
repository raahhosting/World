              ...
              <div class="panel-heading" style="border-bottom:0;">
                ...
                <h3>Software</h3>
                     ...
                     <div class="panel-body" style="padding-top:0;">
                       ...
                       <div>Software ID: {{$download->id}}</div>
                       <div>Software name: {{$download->title}}</div>
                       <div>Software Price: {{$download->price}}</div>
                       <div>Software  quantity: {{$download->pivot->quantity}}</div>
                       </li>
                       @endforeach
                       </ul>
                     </div>
